    ...
    return Scaffold(
      appBar: AppBar(
        ...
        child: Column(
          ...
          children: [
            CommonComponents().printText(fontSize: 18, textData: "Searching for you on the map", fontWeight: FontWeight.bold),
            CommonComponents().printText(fontSize: 16, textData: "please wait or enter the address below", fontWeight: FontWeight.normal)
          ],
        ),),
      ),
      body: Center(
       ...
       children: [
         ...
         Row(
           ...
           children: [
             ...
             Icon(Icons.circle_outlined,color: ColorHelper.blueColor,size: 25.sp,),
             SpaceHelper.horizontalSpace5,
             Obx(()=>SizedBox(
               width: 220.w,
               child: CommonComponents().printText(maxLine:2,fontSize: 18, textData: homeController.myPlaceName.value,
                   fontWeight:homeController.myPlaceName.value=="Searching for you on the map.."?FontWeight.normal: FontWeight.bold,
                   color:homeController.myPlaceName.value=="Searching for you on the map.."?Colors.grey:Colors.white ),
             )),
             Container(
               ...
               child: Center(
                 child: CommonComponents().printText(fontSize: 15, textData: "Entrance", fontWeight: FontWeight.normal),
               ),
             )
           ],
         ),
       ...
       child: Row(
         ...
         children: [
           InkWell(
             ...
             child: Container(
                 height:55.h, width: 90.w,
                 decoration: BoxDecoration(
                     borderRadius: BorderRadius.circular(14),
                     color: homeController.selectedVehicle.value=="car"?Colors.lightBlueAccent.withOpacity(0.5):ColorHelper.bgColor
                 ),
                 child: Padding(
                   padding: const EdgeInsets.all(8.0),
                   child: Row(
                     ...
                     children: [
                       Column(
                         ...
                         children: [
                           Image.asset(
                             'assets/images/car.png',fit: BoxFit.fill, // Replace with your asset
                             width: 40.h,
                             height: 22.h,
                           ),
                           CommonComponents().printText(fontSize: 15, textData: "Car", fontWeight: FontWeight.bold)
                         ],
                       ),
                       homeController.selectedVehicle.value=="car"?
                       Icon(Icons.check_box_outlined,color: Colors.lightBlueAccent,size: 20.sp,):const SizedBox()
                     ],
                   ),
                 )
             ),
           ...
           InkWell(
             ...
             child: Container(
                 ...
                 decoration: BoxDecoration(
                     borderRadius: BorderRadius.circular(14),
                     color: homeController.selectedVehicle.value=="moto"?Colors.lightBlueAccent.withOpacity(0.5):ColorHelper.bgColor
                 ),
                 child: Padding(
                   padding: const EdgeInsets.all(8.0),
                   child: Row(
                     ...
                     children: [
                       Column(
                         ...
                         children: [
                           Image.asset(
                             'assets/images/bike.png',fit: BoxFit.fill, // Replace with your asset
                             width: 40.h,
                             height: 22.h,
                           ),
                           CommonComponents().printText(fontSize: 15, textData: "Moto", fontWeight: FontWeight.bold)
                         ],
                       ),
                       homeController.selectedVehicle.value=="moto"?
                       Icon(Icons.check_box_outlined,color: Colors.lightBlueAccent,size: 20.sp,):const SizedBox()
           ...
           InkWell(
             ...
             child: Container(
                 ...
                 decoration: BoxDecoration(
                     borderRadius: BorderRadius.circular(14),
                     color: homeController.selectedVehicle.value=="cng"?Colors.lightBlueAccent.withOpacity(0.5):ColorHelper.bgColor
                 ),
                 child: Padding(
                   padding: const EdgeInsets.all(8.0),
                   child: Row(
                     ...
                     children: [
                       Column(
                         ...
                         children: [
                           Image.asset(
                             'assets/images/rickshaw.png',fit: BoxFit.fill, // Replace with your asset
                             width: 40.h,
                             height: 22.h,
                           ),
                           CommonComponents().printText(fontSize: 15, textData: "CNG", fontWeight: FontWeight.bold)
                         ],
                       ),
                       homeController.selectedVehicle.value=="cng"?
                       Icon(Icons.check_box_outlined,color: Colors.lightBlueAccent,size: 20.sp,):const SizedBox()
